...
Sphere::Sphere(Shader * pShader, const glm::vec3 & center, float radius, const glm::vec3 & color, const glm::mat4 & model)
        : Shape(pShader, model), center(center), radius(radius), color(color)
{
