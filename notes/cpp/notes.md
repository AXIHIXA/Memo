...
- 定义格式
```
auto f1 = [capture_list] (paramater_list) -> return_type { function_body; };                                         // (1)
return_type (*f2)(paramater_list) = [capture_list] (paramater_list) -> return_type { function_body; };               // (2)
std::function<return_type (paramater_list)> f3 = [capture_list] (paramater_list) -> return_type { function_body; };  // (3)
```
- 内容物
    - 捕获列表
