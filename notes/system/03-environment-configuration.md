...
Last login: Thu Jan 15 11:25:36 on ttys000
(base) xihan@KW97VKC25K ~ % ssh computelab-303
 ...
 * Support:        https://ubuntu.com/pro
 ...
 System information as of Thu Jan 15 07:26:53 PM UTC 2026

  System load:  1.74                Temperature:                 34.0 C
  Usage of /:   29.3% of 877.71GB   Processes:                   1883
  Memory usage: 20%                 Users logged in:             26
  Swap usage:   52%                 IPv4 address for enp129s0f0: 10.32.208.143

  => /workspace is using 86.0% of 1.82TB
...
Welcome to computelab-303.nvidia.com
- This machine is designated for TensorRT development uses

- On first Friday of each month, we will perform a system-wide maintenance
  * all docker container images will be cleared
  * OS patching will be installed
  * System will be rebooted

- This machine is being shared by entire TRT development team (>150 users)

- Please respect other users and follow these guidelines:
  * Do not leave resource demanding processes running for longer period of time
  * If you need workspace on local machine, please create a subfolder in /workspace/users
  * Cleanup workspace after each uses

- Local workspace is provided in /workspace/users as a temporary storage and it is 
  not backed up.
  * Each user can create a local workspace directory with a quota of 75GB
  * Individual users can create a new workspace by running "sudo /usr/local/sbin/mkworkspace"
  * Please clean up the files in local workspace after uses

- Experimental feature: 
  * We are keeping snapshots of local workspace in last 48 hours. Contact infra team in case
    of accidental data loss 

- If this is your first time using Computelab for TensorRT development, see 
  https://confluence.nvidia.com/display/DL/Running+TensorRT+on+ComputeLab for instructions.

- Report any issue in Slack channel #swdl-tensorrt-infra

Last login: Thu Jan 15 19:25:49 2026 from 10.110.66.158

############################################
Local workspace usage (update every 30 min):
############################################

xihan@computelab-303:~$ vi .profile 
xihan@computelab-303:~$ vi .bashrc
xihan@computelab-303:~$ vi .bashrc
xihan@computelab-303:~$ exit
logout
Connection to computelab-303 closed.
(base) xihan@KW97VKC25K ~ % ssh computelab-303
Welcome to Ubuntu 24.04.3 LTS (GNU/Linux 6.8.0-88-generic x86_64)
 ...
 * Support:        https://ubuntu.com/pro
 ...
 System information as of Thu Jan 15 07:35:52 PM UTC 2026

  System load:  1.58                Temperature:                 33.0 C
  Usage of /:   29.3% of 877.71GB   Processes:                   1874
  Memory usage: 20%                 Users logged in:             26
  Swap usage:   52%                 IPv4 address for enp129s0f0: 10.32.208.143
...
Last login: Thu Jan 15 19:27:41 2026 from 10.110.66.158

############################################
Local workspace usage (update every 30 min):
############################################

xihan@computelab-303:~$ echo $TRT_USER
xihan
xihan@computelab-303:~$ ls -la
total 308
drwx------  22 xihan hardware  4096 Jan 15 19:35 .
drwxr-xr-x 102 root  root         0 Jan 15 19:12 ..
-rw-r--r--   1 xihan hardware 13399 Jan  3  2022 .aliases
drwxr-xr-x   2 xihan hardware  4096 Jun 13  2018 app-defaults
-rwxr-xr-x   1 xihan hardware   129 Jul 27  2011 .bash_env
-rw-------   1 xihan hardware  9389 Jan 15 19:35 .bash_history
-rw-r--r--   1 xihan hardware   650 Jan 15 19:35 .bashrc
lrwxrwxrwx   1 xihan hardware    34 Jan 15 01:11 .cache -> /home/scratch.xihan_coreai/.cache/
drwxr-xr-x   8 xihan hardware  4096 Jan  9 18:43 .config
-rw-r--r--   1 xihan hardware 11410 Jul 14  2025 .cshrc
-rw-r--r--   1 xihan hardware   632 Nov  2  2006 .cshrc_custom
-rw-r--r--   1 xihan hardware   256 Jul 27  2011 .cshrc_layout_tools
-rw-r--r--   1 xihan hardware  5416 Jul 15  2022 .cshrc_tools
drwxr-xr-x   3 xihan hardware  4096 Jan  9 00:33 .cursor
drwxr-xr-x   5 xihan hardware  4096 Jan  8 23:59 .cursor-server
drwxr-xr-x   2 xihan hardware  4096 Jan  9 18:43 Desktop
drwx------   3 xihan hardware  4096 Jan 15 01:05 .docker
drwxr-xr-x   2 xihan hardware  4096 Jan  9 18:43 Documents
drwxr-xr-x   2 xihan hardware  4096 Jan 10 01:37 Downloads
drwxrwxr-x   4 xihan hardware  4096 Nov 14 04:27 .envbkup
-rw-r--r--   1 xihan hardware    53 Jan 15 00:30 .gitconfig
-rw-------   1 xihan hardware   314 Jan  9 18:43 .ICEauthority
drwxrwxr-x   2 xihan hardware  4096 Nov 14 04:27 .kde
-rw-------   1 xihan hardware    20 Jan 12 22:32 .lesshst
drwx------   4 xihan hardware  4096 Jan  9 18:43 .local
-rw-r--r--   1 xihan hardware   637 Jan 26  2010 .login
-rw-r--r--   1 xihan hardware   275 Apr 16  2012 .minttyrc
drwxr-xr-x   2 xihan hardware  4096 Jan  9 18:43 Music
drwxr-xr-x   2 xihan hardware  4096 Jan 15 00:32 opt
drwxr-xr-x   2 xihan hardware  4096 Jan  9 18:43 Pictures
-rw-r--r--   1 xihan hardware    62 Jan 15 19:28 .profile
drwxr-xr-x   2 xihan hardware  4096 Jan  9 18:43 Public
-rw-------   1 xihan hardware     7 Jan 12 22:10 .python_history
-rw-r--r--   1 root  root      1120 Nov 14 04:27 README_STORAGE
-rw-r--r--   1 xihan hardware  3147 Jan  6  2005 .show-path
drwxrwxrwx   9 root  root      4096 Jan 15 08:00 .snapshot
drwx------   2 xihan hardware  4096 Jan  9 21:39 .ssh
drwxr-xr-x   2 xihan hardware  4096 Jan  9 18:43 Templates
drwxr-xr-x   2 xihan hardware  4096 Jan  9 18:43 Videos
-rw-------   1 xihan hardware  8885 Jan 15 19:35 .viminfo
drwx------   3 xihan hardware  4096 Jan 15 19:14 .vnc
drwxr-xr-x   2 xihan hardware  4096 Jan  9 00:27 .vscode
lrwxrwxrwx   1 xihan hardware    26 Jan  9 21:33 workspace -> /home/scratch.xihan_coreai
-rw-------   1 xihan hardware   139 Jan  9 18:43 .Xauthority
-rw-r--r--   1 xihan hardware     0 Jan 14  2001 .Xresources
-rw-r--r--   1 xihan hardware 50885 Jan 15 19:24 .zcompdump
-rw-r--r--   1 xihan hardware 40407 Jan 15 19:12 .zcompdump.computelab-303.nvidia.com.990723
-rw-r--r--   1 xihan hardware 19298 Jan 15 19:14 .zcompdump.computelab-303.nvidia.com.992127
xihan@computelab-303:~$ git trt autocomplete > .git-trt-autocomplete.bash
xihan@computelab-303:~$ echo $?
0
xihan@computelab-303:~$ vi .git-trt-autocomplete.bash 
xihan@computelab-303:~$ exit
logout
Connection to computelab-303 closed.
(base) xihan@KW97VKC25K ~ % docker run -h  
 ...
 * Support:        https://ubuntu.com/pro
 ...
 System information as of Thu Jan 15 09:14:33 PM UTC 2026

  System load:  1.45                Temperature:                 33.0 C
  Usage of /:   29.3% of 877.71GB   Processes:                   1933
  Memory usage: 21%                 Users logged in:             26
  Swap usage:   52%                 IPv4 address for enp129s0f0: 10.32.208.143
...
Last login: Thu Jan 15 19:35:53 2026 from 10.110.66.158

############################################
Local workspace usage (update every 30 min):
############################################

xihan@computelab-303:~$ docker run -h
flag needs an argument: 'h' in -h

Usage:  docker run [OPTIONS] IMAGE [COMMAND] [ARG...]

Run 'docker run --help' for more information
xihan@computelab-303:~$ docker run --help
Usage:  docker run [OPTIONS] IMAGE [COMMAND] [ARG...]
